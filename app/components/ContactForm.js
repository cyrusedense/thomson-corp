                  ...
                  <form action="" className="space-y-6">
                    {inputFields.map((placeholder) => (
                      <div className="flex flex-col" key={placeholder}>
                        <input className="border-0 border-b-2 border-white bg-transparent p-2 text-white placeholder-gray-400 focus:outline-none" type="text" id={placeholder.toLowerCase().replace(" ", "-")} placeholder={placeholder} />
                      </div>
                    ))}
                    <div className="flex flex-col">
                      <textarea className="rounded-lg border-0 bg-white p-2 p-3 text-black placeholder-gray-400 focus:outline-none" id="message" rows="4" placeholder="Message" />
                    </div>
