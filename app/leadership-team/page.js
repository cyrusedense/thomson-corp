...
function Leadership() {
  return (
    <div>
      <section className="bg-leadership-hero relative min-h-[50vh] bg-cover bg-right md:min-h-[70vh]">
        ...
        <div className="mx-auto grid max-w-screen-xl gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="first-div flex h-[454px] w-[336px] flex-col justify-around rounded-[56px] rounded-br-[0px] bg-tsyellow p-[10%]">
            ...
            <p className="text-white">
              ...
              mollitia ex autem in soluta possimus, enim, quas eius voluptatem
              quos vitae, labore facilis veritatis? Soluta, vero. Nisi in rerum
              dolore.
            </p>
          </div>
